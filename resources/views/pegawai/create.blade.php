                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('nip') ? ' has-error' : '' }}>
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('jabatan_id') ? ' has-error' : '' }}>
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('golongan_id') ? ' has-error' : '' }}">
