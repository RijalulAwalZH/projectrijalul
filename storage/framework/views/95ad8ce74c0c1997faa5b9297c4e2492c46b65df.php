...
<a href="<?php echo e(url('/lemburpegawai/create')); ?>"class="btn btn-primary form-control">Tambah Data</a>
<br><br>
	<thead>
		<tr class="bg-info">
		<th>No</th>
	...
	<tbody>
		...
		<td><a href="<?php echo e(route('lemburpegawai.edit',$lembur_pegawais->id)); ?>" class="btn btn-warning">Update</a></td>	
		</td>
		<td>
		<?php echo Form::open(['method'=>'DELETE','route'=>['lemburpegawai.destroy',$lembur_pegawais->id]]); ?>
